...
public class RoomsFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    [SerializeField] [Range(0,10)] private int offset = 1; //Prevents rooms from generating next to each other
    ...
    private void CreateRooms()
    {
        ...
        {
            roomCenters.Add((Vector2Int)Vector3Int.RoundToInt(room.center)); //Adds the centerpoints of the rooms to the list
        }
